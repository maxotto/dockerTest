 ...
 * Perepis2010Raw1mux
 *
 * @ORM\Table(name="Perepis_2010_raw_1mux", indexes={@ORM\Index(name="UK_Perepis_2010_raw_1mux_code_4", columns={"code_4"}), @ORM\Index(name="UK_Perepis_2010_raw_1mux_code_2", columns={"code_2"}), @ORM\Index(name="UK_Perepis_2010_raw_1mux_code_3", columns={"code_3"}), @ORM\Index(name="UK_Perepis_2010_raw_1mux_code_1", columns={"code_1"})})
 * @ORM\Entity
 */
class Perepis2010Raw1mux
{
    /**
     * @var string
     *
