 ...
 * HistoryDetailsCopy
 *
 * @ORM\Table(name="history_details_copy", indexes={@ORM\Index(name="IX_history_details_field_name", columns={"field_name"}), @ORM\Index(name="IX_history_details_in_protocol", columns={"in_protocol"}), @ORM\Index(name="IX_history_details_user_id", columns={"user_id"}), @ORM\Index(name="IX_history_details_table_name", columns={"table_name"}), @ORM\Index(name="Index 4", columns={"table_id"})})
 * @ORM\Entity
 */
class HistoryDetailsCopy
{
    /**
     * @var int
     *
     ...
     * @var string|null
     *
     * @ORM\Column(name="old_value", type="text", length=0, nullable=true)
     */
    private $oldValue;
     ...
     * @var string|null
     *
     * @ORM\Column(name="new_value", type="text", length=0, nullable=true)
     */
    private $newValue;
