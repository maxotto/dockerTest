 ...
 * OvParamsArhiv
 *
 * @ORM\Table(name="ov_params_arhiv", indexes={@ORM\Index(name="fcp_object_id", columns={"fcp_object_id"})})
 * @ORM\Entity
 */
class OvParamsArhiv
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="edited_who", type="integer", nullable=true, options={"unsigned"=true})
     */
    private $editedWho;
