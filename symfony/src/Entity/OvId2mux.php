 ...
 * OvId2mux
 *
 * @ORM\Table(name="ov_id2mux", indexes={@ORM\Index(name="fcp_object_id", columns={"fcp_object_id"})})
 * @ORM\Entity
 */
class OvId2mux
{
     ...
     * @var string
     *
     * @ORM\Column(name="antenna_type_txt_init_prim", type="string", length=255, nullable=false)
     */
    private $antennaTypeTxtInitPrim = '';
     ...
     * @var int
     *
     * @ORM\Column(name="has_staff", type="integer", nullable=false, options={"unsigned"=true})
     */
    private $hasStaff = '0';
     ...
     * @var string
     *
     * @ORM\Column(name="has_staff_prim", type="string", length=255, nullable=false)
     */
    private $hasStaffPrim = '';
    ...
    public function getAntennaTypeTxtInitPrim(): ?string
    {
        return $this->antennaTypeTxtInitPrim;
    }

    public function setAntennaTypeTxtInitPrim(string $antennaTypeTxtInitPrim): self
    {
        $this->antennaTypeTxtInitPrim = $antennaTypeTxtInitPrim;
    ...
    public function getHasStaff(): ?int
    {
        return $this->hasStaff;
    }

    public function setHasStaff(int $hasStaff): self
    {
    ...
    public function getHasStaffPrim(): ?string
    {
        return $this->hasStaffPrim;
    }

    public function setHasStaffPrim(string $hasStaffPrim): self
    {
        $this->hasStaffPrim = $hasStaffPrim;
