 ...
 * FcpFinance
 *
 * @ORM\Table(name="fcp_finance", uniqueConstraints={@ORM\UniqueConstraint(name="fcp_object_finyear", columns={"fcp_object_id", "fin_year"})}, indexes={@ORM\Index(name="fcp_object_id", columns={"fcp_object_id"})})
 * @ORM\Entity
 */
class FcpFinance
{
