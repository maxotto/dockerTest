 ...
 * FcpObjects
 *
 * @ORM\Table(name="fcp_objects", indexes={@ORM\Index(name="IDX_fcp_objects_project_type", columns={"project_type"}), @ORM\Index(name="Index 3", columns={"filial_id"}), @ORM\Index(name="has_vsat", columns={"has_vsat"}), @ORM\Index(name="Index 2", columns={"code"})})
 * @ORM\Entity
 */
class FcpObjects
{
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="edited_when", type="datetime", nullable=true)
     */
    private $editedWhen;
     ...
     * @var int
     *
     * @ORM\Column(name="project_status", type="integer", nullable=false, options={"unsigned"=true,"comment"="Статус хода проектирования"})
     */
    private $projectStatus = '0';

    /**
     * @var int
     *
     * @ORM\Column(name="group_1", type="integer", nullable=false, options={"unsigned"=true,"comment"="Группа по приказу 1"})
     */
    private $group1 = '0';
     ...
     * @var int|null
     *
     * @ORM\Column(name="criteria95_ini", type="integer", nullable=true, options={"unsigned"=true,"comment"="Критерий 95%, по первоначальной редакции ФЦП"})
     */
    private $criteria95Ini = '0';

    /**
     * @var int|null
     *
     * @ORM\Column(name="criteria95_fcp2015", type="integer", nullable=true, options={"unsigned"=true,"comment"="Критерий 95%, по редакции ФЦП от 2015 года"})
     */
    private $criteria95Fcp2015 = '0';
     ...
     * @var int|null
     *
     * @ORM\Column(name="build_year_start", type="integer", nullable=true, options={"unsigned"=true,"comment"="Год начала строительства 1 мультиплекса"})
     */
    private $buildYearStart = '0';
     ...
     * @var int|null
     *
     * @ORM\Column(name="build_year_2m_start", type="integer", nullable=true, options={"unsigned"=true,"comment"="Год начала строительства 2 мультиплекса"})
     */
    private $buildYear2mStart = '0';
     ...
     * @var int|null
     *
     * @ORM\Column(name="build_year_dop_nm_start", type="integer", nullable=true, options={"unsigned"=true,"comment"="Год начала строительства дополнительных мультиплексов"})
     */
    private $buildYearDopNmStart = '0';
     ...
     * @var int|null
     *
     * @ORM\Column(name="no_need_razr_exp", type="integer", nullable=true, options={"unsigned"=true,"comment"="Не требуется разрешение на эксплуатацию"})
     */
    private $noNeedRazrExp = '0';

    /**
     * @var int|null
     *
     * @ORM\Column(name="ks14_ready", type="integer", nullable=true, options={"unsigned"=true,"comment"="КС 14 готово"})
     */
    private $ks14Ready = '0';
     ...
     * @var int
     *
     * @ORM\Column(name="has_vsat", type="integer", nullable=false, options={"unsigned"=true})
     */
    private $hasVsat = '0';
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="finish_date", type="date", nullable=false, options={"default"="0000-00-00"})
     */
    private $finishDate = '0000-00-00';
     ...
     * @var int|null
     *
     * @ORM\Column(name="territory_priority_id", type="integer", nullable=true)
     */
    private $territoryPriorityId = '0';

    /**
     * @var int|null
     *
     * @ORM\Column(name="project_type", type="integer", nullable=true, options={"default"="1"})
     */
    ...
    public function setGroup1(int $group1): self
    {
        $this->group1 = $group1;
    ...
    public function getCriteria95Ini(): ?int
    {
        return $this->criteria95Ini;
    }

    public function setCriteria95Ini(?int $criteria95Ini): self
    {
        $this->criteria95Ini = $criteria95Ini;

        return $this;
    }

    public function getCriteria95Fcp2015(): ?int
    {
        return $this->criteria95Fcp2015;
    }

    public function setCriteria95Fcp2015(?int $criteria95Fcp2015): self
    {
        $this->criteria95Fcp2015 = $criteria95Fcp2015;
    ...
    public function getBuildYearStart(): ?int
    {
        return $this->buildYearStart;
    }

    public function setBuildYearStart(?int $buildYearStart): self
    {
        $this->buildYearStart = $buildYearStart;
    ...
    public function getBuildYear2mStart(): ?int
    {
        return $this->buildYear2mStart;
    }

    public function setBuildYear2mStart(?int $buildYear2mStart): self
    {
        $this->buildYear2mStart = $buildYear2mStart;
    ...
    public function getBuildYearDopNmStart(): ?int
    {
        return $this->buildYearDopNmStart;
    }

    public function setBuildYearDopNmStart(?int $buildYearDopNmStart): self
    {
        $this->buildYearDopNmStart = $buildYearDopNmStart;
    ...
    public function getNoNeedRazrExp(): ?int
    {
        return $this->noNeedRazrExp;
    }

    public function setNoNeedRazrExp(?int $noNeedRazrExp): self
    {
        $this->noNeedRazrExp = $noNeedRazrExp;

        return $this;
    }

    public function getKs14Ready(): ?int
    {
        return $this->ks14Ready;
    }

    public function setKs14Ready(?int $ks14Ready): self
    {
        $this->ks14Ready = $ks14Ready;

        return $this;
    }

    public function getHasVsat(): ?int
    {
        return $this->hasVsat;
    }

    public function setHasVsat(int $hasVsat): self
    {
        $this->hasVsat = $hasVsat;
    ...
    public function getTerritoryPriorityId(): ?int
    {
        return $this->territoryPriorityId;
    }

    public function setTerritoryPriorityId(?int $territoryPriorityId): self
    {
        $this->territoryPriorityId = $territoryPriorityId;
